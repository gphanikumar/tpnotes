...
\right) } + \sum_{j=1}^{R}{\kappa_{jk}Q_j}
}
\end{equation}
...
$$ \rho_k \propto {X_k M_w \over V_m } $$ 

The variation of log of the parameters will be equal as the rest of the parameters that are not function of location will be constants.
